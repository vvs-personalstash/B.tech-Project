...
from train_baseline import train_eval_AE, train_eval_MLP
...
if __name__ == "__main__":
    ...
    integrate = save_logits_with_baseline(ind_test_results, "../results/performance/GSD/", "TransDSI", "UB2_indtest.csv", "UB2_TransDSI_indtest3.csv")
